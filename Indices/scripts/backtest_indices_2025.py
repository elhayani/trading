...
def download_data(ticker):
    """Downloads 1h data for 2025"""
    print(f"⬇️ Downloading data for {ticker} (2025)...")
    try:
        # Download data for 2025
        # Note: 1h data is limited to 730 days in yfinance, 2025 is future/current.
        # Check current date. If 2025 is not yet here or just started, we take what we have.
        # The user's system time is 2026. So 2025 is in the past. Perfect.
        df = yf.download(ticker, start="2025-01-01", end="2025-12-31", interval="1h", progress=False)
