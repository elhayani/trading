...
class NewsFetcher:
    ...
    def get_news_context(self, symbol="EURUSD"):
        ...
        # En général déjà bien formaté dans le bot Commodities, mais sécurité :
        if "=" not in ticker_symbol and "USD" not in ticker_symbol:
             # Probablement un test ou fallback
             pass
