#!/bin/bash
#
# Forex Trading - Automatic Deployment Script
# ===========================================
#
...
echo "======================================================================"
echo "💱 FOREX TRADING AWS DEPLOYMENT"
echo "======================================================================"
echo ""
...
echo "📚 Step 1: Building Forex Dependency Layer..."
echo "----------------------------------------------------------------------"

LAYER_DIR="Forex/lambda/layer_forex/python"
rm -rf Forex/lambda/layer_forex
mkdir -p $LAYER_DIR
...
echo -e "${GREEN}✅ Layer prepared in Forex/lambda/layer_forex${NC}"
echo ""
