    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        trading_lambda = lambda_.Function(
            ...
            environment={
                ...
                "CAPITAL": "1000",
                "SYMBOLS": "BTC/USDT:USDT,ETH/USDT:USDT,SOL/USDT:USDT,XRP/USDT:USDT,BNB/USDT:USDT,DOGE/USDT:USDT,PAXG/USDT:USDT,SPX/USDT:USDT,DAX/USDT:USDT,OIL/USDT:USDT,EUR/USD:USDT,USDC/USDT:USDT",
                "RSI_THRESHOLD": "35",
                "CHECK_INTERVAL": "3600",
                "EXCHANGE": "binance",
        ...
        reporter_lambda = lambda_.Function(
            ...
            memory_size=256,
            environment={
                "SYMBOLS": "BTCUSDT,ETHUSDT,SOLUSDT,XRPUSDT,BNBUSDT,DOGEUSDT,PAXGUSDT,SPXUSDT,DAXUSDT,OILUSDT,EURUSDT,USDCUSDT",
                "TRADING_MODE": "live",
                "HISTORY_TABLE": "EmpireTradesHistory",
